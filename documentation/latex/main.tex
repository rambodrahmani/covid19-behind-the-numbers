...
dataset\footnote{Coronavirus Pandemic (COVID-19) – the data, provided by Our
World in Data}, \textbf{this time some preprocessing is needed}. As a matter
fact, the values for some of the dates in the original dataset are missing.
